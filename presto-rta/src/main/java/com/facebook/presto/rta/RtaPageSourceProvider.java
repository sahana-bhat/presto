        ...
        implements ConnectorPageSourceProvider
{
    ...
    public ConnectorPageSource createPageSource(ConnectorTransactionHandle transactionHandle, ConnectorSession session, ConnectorSplit split, ConnectorTableLayoutHandle layout, List<ColumnHandle> columns)
    {
        ...
        return connectorProvider.getConnector(rtaSplit.getKey()).getPageSourceProvider().createPageSource(transactionHandle, session, rtaSplit.getSplit(), ((RtaTableLayoutHandle) layout).createConnectorSpecificTableLayoutHandle(), columns);
    }
}
