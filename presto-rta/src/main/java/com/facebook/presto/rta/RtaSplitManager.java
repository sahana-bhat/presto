        ...
        implements ConnectorSplitManager
{
    ...
    public ConnectorSplitSource getSplits(ConnectorTransactionHandle transactionHandle, ConnectorSession session, ConnectorTableLayoutHandle layout, SplitSchedulingContext splitSchedulingContext)
    {
        ...
        return new RtaConnectorSplitSource(connectorProvider.getConnector(rtaTableLayoutHandle.getTable().getKey()).getSplitManager().getSplits(transactionHandle, session, rtaTableLayoutHandle.createConnectorSpecificTableLayoutHandle(), splitSchedulingContext), rtaConnectorId, rtaTableLayoutHandle.getTable().getKey());
    }
