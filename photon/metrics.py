...
METRICS = [
{
    ...
    "metrics": [('HeapMemoryUsage', ['committed', 'init', 'max', 'used'], 'GAUGE'), ('NonHeapMemoryUsage', ['committed', 'init', 'max', 'used'], 'GAUGE'), ('ObjectPendingFinalizationCount',None, 'GAUGE')]
},
{
...
{
    "prefix": "presto.namenode",
    "mbean": "com.facebook.presto.hive:type=NamenodeStats,name=hive"
},
{
    "prefix": "presto.queryexecution",
    "mbean": "com.facebook.presto.execution:name=QueryExecution"
},
{
    "prefix": "presto.memory.cluster",
    "mbean": "com.facebook.presto.memory:name=ClusterMemoryManager"
},
{
    "prefix": "presto.memory.clustermemorypool.general",
    "mbean": "com.facebook.presto.memory:type=ClusterMemoryPool,name=general"
},
{
...
},
{
    ...
    "metrics": ["ExecutionTime.FiveMinutes.P50", "ExecutionTime.FiveMinutes.P90", "QueuedTime.FiveMinutes.P50", "QueuedTime.FiveMinutes.P90",
                "runningqueries", "totaltasks"]
},
{
    "prefix": "presto.Execution",
...
{
    "prefix": "presto.hms",
    "mbean": "com.facebook.presto.hive.metastore.thrift:name=hive,type=ThriftHiveMetastore"
},
{
    "prefix": "presto.event_listener",
    "mbean": "com.facebook.presto.eventlistener:name=EventListenerStats"
},
{
    "prefix": "presto.hdfs",
...
TIME_SERIES = construct_regex(['OneMinute', 'FiveMinute', 'FifteenMinute', 'AllTime'])
...
def main():
    ...
    parser.add_argument(
        '-c',
        '--conf-path',
        default='/home/udocker/photon/photon/metrics.conf',
        help='Path to config file (default %(default)s)'
    )
    parser.add_argument(
        '-l',
        '--log-file',
        default='/home/udocker/photon/photon/metrics.log',
