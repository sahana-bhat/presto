...
import static com.facebook.presto.parquet.readerv2.decoders.TestParquetUtils.generateDictionaryIdPage2048;
import static com.facebook.presto.parquet.readerv2.decoders.TestParquetUtils.generatePlainValuesPage;
...
public class TestValuesDecoders
{
    ...
    private static Int64TimestampMicrosPlainValuesDecoder int64TimestampMicrosPlain(byte[] pageBytes)
    {
    ...
    private static Int64TimestampMicrosRLEDictionaryValuesDecoder int64TimestampMicrosDictionary(byte[] pageBytes, int dictionarySize, LongDictionary dictionary)
    {
    ...
    private static BinaryValuesDecoder binaryDictionary(byte[] pageBytes, int dictionarySize, BinaryDictionaryV2 dictionary)
    {
            ...
            throws IOException
    {
        ...
        byte[] dictionaryPage = generatePlainValuesPage(dictionarySize, -1, random, dictionary);
        byte[] dataPage = generateDictionaryIdPage2048(dictionarySize - 1, random, dictionaryIds);
        ...
        BinaryDictionaryV2 binaryDictionary = new BinaryDictionaryV2(new DictionaryPage(Slices.wrappedBuffer(dictionaryPage), dictionarySize, PLAIN_DICTIONARY));
