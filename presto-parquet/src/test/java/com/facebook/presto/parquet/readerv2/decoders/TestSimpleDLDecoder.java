...
import static com.facebook.presto.parquet.readerv2.decoders.TestParquetUtils.addDLRLEBlock;
import static com.facebook.presto.parquet.readerv2.decoders.TestParquetUtils.addDLValues;
import static com.facebook.presto.parquet.readerv2.decoders.TestParquetUtils.randomValues;
import static java.lang.Math.min;
import static org.testng.Assert.assertEquals;
import static org.testng.Assert.fail;

public class TestSimpleDLDecoder
{
            ...
            throws IOException
    {
        ...
        // read all at once
        {
            SimpleDLDecoder dlDecoder = new SimpleDLDecoder(rleValue ? 0 : 1, 200);
            ...
            throws IOException
    {
        ...
        SimpleDLDecoder dlDecoder = new SimpleDLDecoder(valueCount, new ByteArrayInputStream(pageBytes));
        int offset = 0;
        int nonNullCount = 0;
    ...
    public void tryReadingTooMany()
    {
        ...
        try {
            ...
            assertEquals(e.getMessage(), "Failed to copy the requested number of DLs");
        }
    }
}
