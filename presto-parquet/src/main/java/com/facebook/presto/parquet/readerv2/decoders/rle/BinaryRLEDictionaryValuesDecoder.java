...
{
    private final BinaryDictionaryV2 dictionary;

    public BinaryRLEDictionaryValuesDecoder(int bitWidth, InputStream in, BinaryDictionaryV2 dictionary)
    {
        ...
        while (remainingToCopy > 0) {
            ...
            switch (this.mode) {
                ...
                case PACKED: {
                    ...
                    final BinaryDictionaryV2 localDictionary = this.dictionary;
