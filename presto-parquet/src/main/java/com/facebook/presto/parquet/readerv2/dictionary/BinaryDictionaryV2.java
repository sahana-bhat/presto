...
package com.facebook.presto.parquet.readerv2.dictionary;
...
public final class BinaryDictionaryV2
        extends Dictionary
{
    ...
    public BinaryDictionaryV2(DictionaryPage dictionaryPage)
    {
        super(dictionaryPage.getEncoding());
        requireNonNull(dictionaryPage, "dictionaryPage is null");
        checkArgument(dictionaryPage.getDictionarySize() >= 0, "Dictionary size should be >= 0");
