...
import com.facebook.presto.parquet.readerv2.decoders.Int64TimestampMicrosValuesDecoder;
        ...
        implements Int64TimestampMicrosValuesDecoder
{
    ...
    public Int64TimestampMicrosRLEDictionaryValuesDecoder(int bitWidth, InputStream in, LongDictionary dictionary)
    {
            ...
            switch (this.mode) {
                ...
                case PACKED: {
                    ...
                    for (int srcIndex = this.currentBuffer.length - this.currentCount; destIndex < endIndex; srcIndex++) {
                        ...
                        values[destIndex++] = MICROSECONDS.toMillis(dictionaryValue);
                    }
                    break;
                }
                default:
