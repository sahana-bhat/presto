...
public class SemiTransactionalHiveMetastore
{
    ...
    public synchronized Optional<List<String>> getPartitionNamesByParts(ConnectorIdentity identity, String databaseName, String tableName, List<String> parts)
    {
        return doGetPartitionNames(identity, databaseName, tableName, Optional.of(parts));
    }

    @GuardedBy("this")
    private Optional<List<String>> doGetPartitionNames(ConnectorIdentity identity, String databaseName, String tableName, Optional<List<String>> parts)
    {
        checkHoldsLock();
