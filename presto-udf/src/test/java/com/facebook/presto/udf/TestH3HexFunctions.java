        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        this.funcAssert.getMetadata().registerBuiltInFunctions(extractFunctions(plugin.getFunctions()));
    }
    ...
    private static LocalQueryRunner createLocalQueryRunner()
    {
        ...
        UserDefinedFunctionsPlugin plugin = new UserDefinedFunctionsPlugin();
        localQueryRunner.getMetadata().registerBuiltInFunctions(extractFunctions(new UserDefinedFunctionsPlugin().getFunctions()));
