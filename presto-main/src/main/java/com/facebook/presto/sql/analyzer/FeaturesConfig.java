...
public class FeaturesConfig
{
    ...
    public enum ApproxResultsOption
    {
        ...
        APPROX_DISTINCT,
        SAMPLING,
        SAMPLING_WITH_PARTITION_MATCH,
        SAMPLING_WITH_FAIL_CLOSE,
        SAMPLING_WITH_FAIL_CLOSE_WITH_PARTITION_MATCH,
        APPROX_DISTINCT_WITH_SAMPLING,
        APPROX_DISTINCT_WITH_SAMPLING_WITH_PARTITION_MATCH,
        APPROX_DISTINCT_WITH_SAMPLING_WITH_FAIL_CLOSE,
        APPROX_DISTINCT_WITH_SAMPLING_WITH_FAIL_CLOSE_WITH_PARTITION_MATCH,
    }
