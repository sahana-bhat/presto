...
import static com.facebook.presto.geospatial.serde.EsriGeometrySerde.geometryFromBinary;
import static com.facebook.presto.geospatial.serde.EsriGeometrySerde.geometryFromText;
...
public final class GeometryCastOperators
{
    ...
    {
        return EsriGeometrySerde.serialize(geometryFromText(value));
    }
    ...
    {
        return EsriGeometrySerde.serialize(geometryFromBinary(value));
    }
}
