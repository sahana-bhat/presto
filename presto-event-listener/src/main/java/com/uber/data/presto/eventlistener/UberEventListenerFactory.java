        ...
        implements EventListenerFactory
{
    ...
    public EventListener create(Map<String, String> map)
    {
        ...
        boolean logToM3 = map.get("event-listener.log-to-m3") != null && Boolean.parseBoolean(map.get("event-listener.log-to-m3"));

        if (cluster.isEmpty() || engine.isEmpty()) {
            return new EventListener() {};
        }
        else {
            return new UberEventListener(topic, engine, cluster, syncProduce, logOnlyCompleteEvent, logToM3);
        }
    }
}
