...
public class AresDbProjectExpressionConverter
        implements RowExpressionVisitor<AresDbExpression, Map<VariableReferenceExpression, Selection>>
{
    ...
    public AresDbProjectExpressionConverter(
    ...
    @Override
    public AresDbExpression visitInputReference(InputReferenceExpression reference, Map<VariableReferenceExpression, Selection> context)
    {
        throw new AresDbException(ARESDB_UNSUPPORTED_EXPRESSION, null, "Input reference not supported: " + reference);
    }

    @Override
    public AresDbExpression visitVariableReference(VariableReferenceExpression reference, Map<VariableReferenceExpression, Selection> context)
    {
        Selection input = requireNonNull(context.get(reference), format("Input column %s does not exist in the input: %s", reference, context));
        return new AresDbExpression(input.getDefinition(), Optional.empty(), input.getOrigin());
    }

    @Override
    public AresDbExpression visitConstant(ConstantExpression literal, Map<VariableReferenceExpression, Selection> context)
    {
        return new AresDbExpression(getLiteralAsString(literal), Optional.empty(), AresDbQueryGeneratorContext.Origin.LITERAL);
    }

    @Override
    public AresDbExpression visitLambda(LambdaDefinitionExpression lambda, Map<VariableReferenceExpression, Selection> context)
    {
    ...
    private AresDbExpression handleCast(
            CallExpression cast,
    ...
    @Override
    public AresDbExpression visitCall(CallExpression call, Map<VariableReferenceExpression, Selection> context)
    {
    ...
    @Override
    public AresDbExpression visitSpecialForm(SpecialFormExpression specialForm, Map<VariableReferenceExpression, Selection> context)
    {
    ...
    private AresDbExpression handleNot(CallExpression not, Map<VariableReferenceExpression, Selection> context)
    {
    ...
    private AresDbExpression handleDateTrunc(CallExpression function, Map<VariableReferenceExpression, Selection> context)
    {
