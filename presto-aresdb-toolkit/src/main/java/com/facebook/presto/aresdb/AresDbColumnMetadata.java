...
public class AresDbColumnMetadata
        extends ColumnMetadata
{
    ...
    public AresDbColumnMetadata(String name, Type type)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        AresDbColumnMetadata other = (AresDbColumnMetadata) obj;
