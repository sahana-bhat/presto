    ...
    public static Object[][] pqlResponsesProvider()
    {
        return new Object[][] {
                ...
                {"SELECT tag_value FROM eats_job_state LIMIT 10",
                        "{\"selectionResults\":{\"columns\":[\"tag_value\"],\"results\":[[[\"restaurant_missed_request\"]],[[\"restaurant_not_tasty\", \"restaurant_not_worth_price\"]],[[\"rush_business_note_unclear\", \"rush_hard_to_find_merchant\"]],[[\"null\"]],[[\"rush_business_note_unclear\", \"rush_hard_to_find_merchant\", \"rush_no_parking_merchant\", \"rush_too_far\"]],[[\"restaurant_missed_request\"]],[[\"null\"]],[[\"null\"]],[[\"restaurant_fast\", \"restaurant_tasty\"]],[[\"null\"]]]},\"exceptions\":[],\"numServersQueried\":7,\"numServersResponded\":7,\"numDocsScanned\":380,\"numEntriesScannedInFilter\":0,\"numEntriesScannedPostFilter\":760,\"totalDocs\":55988817,\"numGroupsLimitReached\":false,\"timeUsedMs\":2,\"segmentStatistics\":[],\"traceInfo\":{}}",
                        ImmutableList.of(varchar("tag_value")),
                        ImmutableList.of(0),
                        ImmutableList.of(varchar("tag_value")),
                        Optional.empty()},
