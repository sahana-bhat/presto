        ...
        extends TestPinotQueryBase
{
    ...
    public void testPrunedColumns()
    {
        ...
        PinotSplit mockPinotSplit = new PinotSplit(realtimeOnlyTable, PinotSplit.SplitType.SEGMENT, expectedColumnHandles, Optional.empty(), Optional.of("blah"), ImmutableList.of("seg"), Optional.of("host"));
        ...
        for (int i = 0; i < dataTables.size(); ++i) {
            ...
            for (int j = 0; j < columnsSurviving.size(); ++j) {
                ...
                Type type = PinotColumnUtils.getPrestoTypeFromPinotType(getFieldSpec("dontcare", ALL_TYPES.get(originalColumnIndex)));
    ...
    public void testAllDataTypes()
    {
        ...
        PinotSplit mockPinotSplit = new PinotSplit(realtimeOnlyTable, PinotSplit.SplitType.SEGMENT, pinotColumnHandles, Optional.empty(), Optional.of("blah"), ImmutableList.of("seg"), Optional.of("host"));
